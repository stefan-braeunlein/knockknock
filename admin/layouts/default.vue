  ...
  <div class="min-h-screen flex bg-gray-50">
    ...
    <aside class="w-72 bg-blue-50 border border-blue-200 border-dashed rounded-2xl m-4 p-6 flex flex-col">
      ...
      <div class="mt-auto">
        ...
        <p class="text-gray-400 text-xs mt-4 text-center">Powered by <strong class="text-gray-600">Knock Knock HR</strong></p>
      </div>
    </aside>
